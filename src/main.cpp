...
static void cputemp_bar_event_cb(lv_event_t *e);
...
lv_obj_t *lv_example_bar_3(void)
{
    ...
    lv_obj_add_event_cb(bar, cputemp_bar_event_cb, LV_EVENT_VALUE_CHANGED, barlabel);
...
static void cputemp_bar_event_cb(lv_event_t *e)
{
    ...
    lv_obj_t *barlabel = (lv_obj_t *)lv_event_get_user_data(e);
    int32_t value = lv_bar_get_value(bar);
    // Serial.printf("value%llu\n",value);

    lv_label_set_text_fmt(barlabel, "CPU:%d°C", value);
}
